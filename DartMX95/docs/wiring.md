...
- ESP32: Powered externally (buck converter from main battery)
...
================================================================================
        ...
        |  Pin 18 ---> ESP32 GPIO22 (SCL)       |
        |  Pin 20 ---> ESP32 GPIO21 (SDA)       |
        |  Pin 12 ---> ESP32 GND                |
        |                                        |
        +----------------------------------------+
                   ...
                   |      USB         |
                   |                  |
              3V3  | o            o | VIN <-------- Buck Converter 5V
              GND  | o            o | GND --------> DART-MX95 J6 Pin 15
              D15  | o            o | D13 (GPIO13) -> IN4
              D2   | o            o | D12 (GPIO12) -> IN3
              D4   | o            o | D14 (GPIO14) -> ENB
              D16  | o            o | D27 (GPIO27) -> IN2
              D17  | o            o | D26 (GPIO26) -> IN1
...
[ ] Buck converter 5V output to ESP32 VIN
[ ] DART-MX95 J6 Pin 15 (GND) to ESP32 GND
...
COMMUNICATION (I2C):
[ ] DART-MX95 J6 Pin 18 (I2C3_SCL) to ESP32 GPIO22 (SCL)
[ ] DART-MX95 J6 Pin 20 (I2C3_SDA) to ESP32 GPIO21 (SDA)
...
4. Configure I2C communication between systems
